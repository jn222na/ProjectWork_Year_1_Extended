...
//            holder.phonenumber = (TextView) row.findViewById(R.id.phonenumber_ListItem);
    ...
    private void setHolder(int position, GetSettersHolder holder) {
        ...
        holder.firstname.setText(in.getFirstname());
        holder.firstname.setLayoutParams(tlparams);

        holder.lastname.setText(in.getLastname());
        holder.lastname.setLayoutParams(tlparams);
        //holder.phonenumber.setText(in.getPhonenumber());
        //holder.phonenumber.setWidth(width);
    }
